...
--------------------------------------------------------
-- 14. Podaj długość tych z rzek, które przepływają przez terytorium Polski. Ogranicz swoje obliczenia tylko
--     do tych fragmentów, które leżą na terytorium Polski
